...
import { deleteNationalConference, getNationalConference } from '../../redux/actions/conference';
import { toast } from 'react-hot-toast';
import { loadUser } from '../../redux/actions/user';

const NationalConferenceTable = ({ conferenceData }) => {
    ...
    const deleteHandler = (id) => {
        dispatch(deleteNationalConference(id));
    }
...
export default NationalConferenceTable
