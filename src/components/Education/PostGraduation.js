...
import { createEducationPostGraduation } from '../../redux/actions/education.js';
...
const PostGraduation = () => {
  ...
  const { error, message,loading } = useSelector(state => state.educationPostGraduation);
  ...
  const submitHandler = (e) => {
    ...
    dispatch(createEducationPostGraduation(myForm));
  }
