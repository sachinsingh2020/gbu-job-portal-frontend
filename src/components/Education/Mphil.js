...
import { createEducationMphil } from '../../redux/actions/education.js';
...
const Mphil = () => {
  ...
  const { error, message,loading } = useSelector(state => state.educationMphil);
  ...
  const submitHandler = (e) => {
    ...
    dispatch(createEducationMphil(myForm));
  }
